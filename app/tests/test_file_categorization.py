...
class FileCategoryModelTest(TestCase):
    ...
    def test_default_category_is_active(self):
        """Test that new files default to 'active' category."""
        new_file = ResumeFile(
            user_id=self.test_user.id,
...
class FileCategoryServiceTest(TestCase):
    ...
    def test_update_file_category_invalid_category(self):
        ...
        self.assertEqual(context.exception.error_code, ErrorCode.INVALID_INPUT)
    ...
    def test_update_file_category_file_not_found(self):
        ...
        self.assertEqual(context.exception.error_code, ErrorCode.FILE_NOT_FOUND)
...
class FileCategoryAPITest(TestCase):
    ...
    def create_app(self):
        ...
        JWTManager(app)
        app.register_blueprint(file_category_bp)
    ...
    def setUp(self):
        ...
        self.jwt_patcher = patch('flask_jwt_extended.get_jwt_identity')
        self.mock_jwt = self.jwt_patcher.start()
        self.mock_jwt.return_value = self.test_user.id
    ...
    def test_list_files_by_category(self):
        ...
        response = self.client.get('/files?category=active')
    ...
    def test_get_category_statistics(self):
        ...
        response = self.client.get('/files/categories/stats')
    ...
    def test_get_available_categories(self):
        ...
        response = self.client.get('/files/categories')
